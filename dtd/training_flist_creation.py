...
parser.add_argument('--train_filename', default='./train_shuffled.flist', type=str,
                    help='The output filename.')
parser.add_argument('--validation_filename', default='./validation_shuffled.flist', type=str,
                    help='The output filename.')
